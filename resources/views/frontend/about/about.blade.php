            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="content-area">
                        ...
                        <div class="bottom-author-area">
                            ...
                            <div class="sign">
                                <img src="{{ asset('/') }}front/assets/images/home-1/hero/sign.png" alt="signature">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="hero-image">
                        <div class="image">
                            <img src="{{ asset('/') }}front/assets/images/home-1/hero/top-story12.png" alt="hero">
                        </div>
                        <div class="image image-2">
                            <img src="{{ asset('/') }}front/assets/images/home-1/hero/top-story13.png" alt="hero">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="echo-team-area-inner">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="team-wrapper">
                        <div class="image-area">
                            <img src="{{ asset('/') }}front/assets/images/team/team-01.png" alt="team">
                        </div>
                        <div class="content-area">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team-wrapper">
                        <div class="image-area">
                            <img src="{{ asset('/') }}front/assets/images/team/team-02.png" alt="team">
                        </div>
                        <div class="content-area">
                            <ul class="social-icon">
                                <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team-wrapper">
                        <div class="image-area">
                            <img src="{{ asset('/') }}front/assets/images/team/team-03.png" alt="team">
                        </div>
                        <div class="content-area">
                            <ul class="social-icon">
                                <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team-wrapper last">
                        <div class="image-area">
                            <img src="{{ asset('/') }}front/assets/images/team/team-04.png" alt="team">
                        </div>
                        <div class="content-area">
                            <ul class="social-icon">
