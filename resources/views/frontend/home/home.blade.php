                        ...
                        <div class="col-xl-8 col-lg-7 col-md-12">
                            <div class="echo-hero-baner">
                                <div class="echo-hero-banner-main-img  img-transition-scale">
                                    <a href="post-details.html"><img class="banner-image-one img-hover" src="{{ asset('/') }}front/assets/images/home-1/hero/hero-benar.png" alt="Echo"></a>
                                </div>
                            ...
                            <div class="echo-home-1-hero-area-top-story">
                                ...
                                <div class="echo-top-story first">
                                    <div class="echo-story-picture img-transition-scale">
                                        <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/hero/top-story11.png" alt="Echo" class="img-hover"></a>
                                    </div>
                                ...
                                <div class="echo-top-story">
                                    <div class="echo-story-picture img-transition-scale">
                                        <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/hero/top-story1.png" alt="Echo" class="img-hover"></a>
                                    </div>
                                    <div class="echo-story-text">
                                ...
                                <div class="echo-top-story">
                                    <div class="echo-story-picture img-transition-scale">
                                        <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/hero/top-story2.png" alt="Echo" class="img-hover"></a>
                                    </div>
                                    <div class="echo-story-text">
                                ...
                                <div class="echo-top-story">
                                    <div class="echo-story-picture img-transition-scale">
                                        <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/hero/top-story3.png" alt="Echo" class="img-hover"></a>
                                    </div>
                                    <div class="echo-story-text">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="echo-latest-news-main-content">
                                    <div class="echo-latest-news-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/latest-news/item-1.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="echo-latest-news-main-content">
                                    <div class="echo-latest-news-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/latest-news/item-2.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-latest-news-single-title">
                            ...
                            <div class="swiper-slide">
                                <div class="echo-latest-news-main-content">
                                    <div class="echo-latest-news-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/latest-news/item-3.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-latest-news-single-title">
                            ...
                            <div class="swiper-slide">
                                <div class="echo-latest-news-main-content">
                                    <div class="echo-latest-news-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/latest-news/item-4.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-latest-news-single-title">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="echo-trending-left-site-post">
                                <div class="echo-trending-left-site-post-img img-transition-scale">
                                    <a href="post-details.html">
                                        <img src="{{ asset('/') }}front/assets/images/home-1/trending-left/item-1.png" alt="Echo" class="img-hover">
                                    </a>
                                </div>
                            ...
                            <div class="echo-trending-left-site-post">
                                <div class="echo-trending-left-site-post-img img-transition-scale">
                                    <a href="post-details.html">
                                        <img src="{{ asset('/') }}front/assets/images/home-1/trending-left/item-2.png" alt="Echo" class="img-hover">
                                    </a>
                                </div>
                                <div class="echo-trending-right-site-post-title">
                            ...
                            <div class="echo-trending-left-site-post">
                                <div class="echo-trending-left-site-post-img img-transition-scale">
                                    <a href="post-details.html">
                                        <img src="{{ asset('/') }}front/assets/images/home-1/trending-left/item-3.png" alt="Echo" class="img-hover">
                                    </a>
                                </div>
                                <div class="echo-trending-right-site-post-title">
                            ...
                            <div class="echo-trending-left-site-post">
                                <div class="echo-trending-left-site-post-img img-transition-scale">
                                    <a href="post-details.html">
                                        <img src="{{ asset('/') }}front/assets/images/home-1/trending-left/item-4.png" alt="Echo" class="img-hover">
                                    </a>
                                </div>
                                <div class="echo-trending-right-site-post-title">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="echo-trending-right-site-post">
                                <div class="echo-trending-right-site-post-img img-transition-scale">
                                    <a href="post-details.html">
                                        <img src="{{ asset('/') }}front/assets/images/home-1/trending-right/item-1.png" alt="Echo" class="img-hover">
                                    </a>
                                </div>
                                <div class="echo-trending-right-site-post-title">
                            ...
                            <div class="echo-trending-right-site-post">
                                <div class="echo-trending-right-site-post-img img-transition-scale">
                                    <a href="post-details.html">
                                        <img src="{{ asset('/') }}front/assets/images/home-1/trending-right/item-2.png" alt="Echo" class="img-hover">
                                    </a>
                                </div>
                                <div class="echo-trending-right-site-post-title">
                    ...
                    <div class="row gx-6">
                        <div class="col-xl-8 col-lg-8 col-md-12">
                            <div class="echo-video-left-site">
                                <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/video-left/item.png" alt="Echo"></a>
                            ...
                            <div class="echo-video-area-home-1-right-content-responsive">
                                <div class="echo-video-right-site-content">
                                    <div class="echo-video-right-site-content-text">
                                        <h5 class="text-capitalize"><a href="post-details.html" class="title-hover text-white">Baidu shares drop to 8-week lows after...</a>
                                        </h5>
                                        <hr>
                                    ...
                                    <div class="echo-video-right-site-content-video">
                                        <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/video-right/item-1.png" alt="Echo"></a>
                                        <div class="vedio-icone">
                                ...
                                <div class="echo-video-right-site-content">
                                    <div class="echo-video-right-site-content-text">
                                        <h5 class="text-capitalize"><a href="post-details.html" class="title-hover text-white">Christchurch mosque attacks: Keeping...</a>
                                        </h5>
                                        <hr>
                                        <a href="#" class="pe-none text-white"><i class="fa-light fa-clock"></i> 06 minute
                                            read</a>
                                    ...
                                    <div class="echo-video-right-site-content-video">
                                        <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/video-right/item-2.png" alt="Echo"></a>
                                        <div class="vedio-icone">
                                            <a class="play-video popup-youtube video-play-button" href="https://www.youtube.com/watch?v=Jf1BB4EN36g">
                                                <span></span>
                                            </a>
                                ...
                                <div class="echo-video-right-site-content">
                                    ...
                                    <div class="echo-video-right-site-content-video">
                                        <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/video-right/item-3.png" alt="Echo"></a>
                                        <div class="vedio-icone">
                                            <a class="play-video popup-youtube video-play-button" href="https://www.youtube.com/watch?v=Jf1BB4EN36g">
                                                <span></span>
                                            </a>
                            ...
                            <div class="echo-de-category-content echo-responsive-wd">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-1.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-2.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-3.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="echo-de-category-content">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-4.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-5.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-6.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="echo-de-category-content">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-7.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-8.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                                ...
                                <div class="echo-de-category-content-img-title">
                                    <div class="echo-de-category-content-img img-transition-scale">
                                        <a href="post-details.html">
                                            <img src="{{ asset('/') }}front/assets/images/home-1/de-category/item-9.png" alt="Echo" class="img-hover">
                                        </a>
                                    </div>
                                    <div class="echo-de-category-content-title">
                                ...
                                <div class="row gx-5">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="echo-feature-area-post">
                                            <div class="echo-feature-area-post-img img-transition-scale">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('/') }}front/assets/images/home-1/feature-left/item-1.png" alt="Echo" class="img-hover">
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="echo-feature-area-post">
                                            <div class="echo-feature-area-post-img img-transition-scale">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('/') }}front/assets/images/home-1/feature-left/item-2.png" alt="Echo" class="img-hover">
                                                </a>
                                            </div>
                                            <div class="echo-feature-area-post-hins">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                            <div class="echo-feature-area-option-content">
                                                ...
                                                <div class="echo-feature-area-option-content-text">
                                                    <h5 class="text-capitalize"><a href="post-details.html" class="title-hover">UK bans TikTok on government devices</a>
                                                    </h5>
                                ...
                                <div class="echo-feature-area-last-news">
                                    <div class="row gy-5">
                                        <div class="col-xl-12">
                                            <div class="echo-feature-area-last-content">
                                                <div class="echo-feature-area-last-content-img img-transition-scale">
                                                    <a href="post-details.html"> <img src="{{ asset('/') }}front/assets/images/home-1/feature-left/item-3.png" alt="Echo" class="img-hover"></a>
                                                </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="echo-feature-area-last-content">
                                                <div class="echo-feature-area-last-content-img img-transition-scale">
                                                    <a href="post-details.html"> <img src="{{ asset('/') }}front/assets/images/home-1/feature-left/item-4.png" alt="Echo" class="img-hover"></a>
                                                </div>
                                                <div class="echo-feature-area-last-content-text">
                                    ...
                                    <div class="echo-audio-news-home-1-flexing">
                                        <div class="echo-feature-area-right-site-audio-news">
                                            <div class="echo-feature-area-right-img">
                                                <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/feature-right/item-1.png" alt="Echo"></a>
                                            </div>
                                                ...
                                                <div class="echo-feature-area-right-site-audio-main-contetn">
                                                    ...
                                                    <div class="wrappers">
                                                        <audio preload="auto" controls>
                                                            <source src="{{ asset('/') }}front/assets/images/home-1/feature-right/my-audio.mp3" type="audio/mpeg">
                                                        </audio>
                                                    </div>
                                                    <!-- End Audio Player -->
                                                </div>
                                        ...
                                        <div class="echo-feature-area-right-site-audio-news">
                                            <div class="echo-feature-area-right-img">
                                                <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/feature-right/item-2.png" alt="Echo"></a>
                                            </div>
                                            <div class="echo-feature-area-right-audio-text">
                                        ...
                                        <div class="echo-feature-area-right-site-audio-news">
                                            <div class="echo-feature-area-right-img">
                                                <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/feature-right/item-3.png" alt="Echo"></a>
                                            </div>
                                            <div class="echo-feature-area-right-audio-text">
                ...
                <div class="echo-popular-news-area-full-content">
                    ...
                    <div class="row gx-5">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="echo-popular-area-single-item">
                                <div class="echo-popular-area-img img-transition-scale">
                                    <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/popular/item-1.png" alt="Echo" class="img-hover"></a>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="echo-popular-area-single-item">
                                <div class="echo-popular-area-img img-transition-scale">
                                    <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/popular/item-2.png" alt="Echo" class="img-hover"></a>
                                </div>
                                <div class="echo-popular-area-item-title">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="echo-popular-area-single-item echo-popular-news-responsive-home-1">
                                <div class="echo-popular-area-img img-transition-scale">
                                    <a href="post-details.html"><img src="{{ asset('/') }}front/assets/images/home-1/popular/item-3.png" alt="Echo" class="img-hover"></a>
                                </div>
                                <div class="echo-popular-area-item-title">
        ...
        <div class="container">
            <div class="echo-software-download-full-content-bg">
                <div class="echo-software-download-img-content">
                    <img src="{{ asset('/') }}front/assets/images/home-1/our-android-app-download/item-1.png" alt="Echo">
                </div>
                <div class="row">
                    <div class="col-xl-12">
