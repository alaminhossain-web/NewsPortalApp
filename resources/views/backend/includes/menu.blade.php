            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <span class="side-menu__icon"><i class="fa fa-th-large"></i></span> 
                        <span class="side-menu__label">Blog Category</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Blog Category</a></li>
                        <li><a href="{{route('blog-categories.create')}}" class="slide-item">Add Blog Category</a></li>
                        <li><a href="{{route('blog-categories.index')}}" class="slide-item">Manage BLog Category</a></li>
                        
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <span class="side-menu__icon"><i class="pe-7s-news-paper"></i></span>
                        <span class="side-menu__label"> Blogs</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Blogss</a></li>
                        
                        <li><a href="{{route('blogs.create')}}" class="slide-item">Add Blog
                            </a></li>
